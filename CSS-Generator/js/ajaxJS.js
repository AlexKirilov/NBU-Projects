    ...
    $('#cssactions').children('li').click(function() {
        ...
        $(this).each(function(i){
            ...
            if(title_data == "RGBA" && clicked_val != title_data){
                ...
                $('#operations').append("<p><input type='text' id='color_R' />Color R </p>");
                $('#operations').append("<p><input type='text' id='color_G' />Color G </p>");
                $('#operations').append("<p><input type='text' id='color_B' />Color B </p>");
                $('#operations').append("<p><input type='text' id='opacity_color' />Opacity </p>");
               ...
               $('#sample').css('background-color',"rgb("+RGB_values[1]+","+RGB_values[2]+','+RGB_values[3]+')');
                });
                
            }else if(title_data == "Multiple Columns" && clicked_val != title_data){
                clicked_val = title_data;
                $('#operations').append("<p><input type='text' id='mult_column' /></p>");
                ...
                clicked_val = title_data;
                $("#operations").append("<p><input type='text' id='bord_rad' /></p>");
