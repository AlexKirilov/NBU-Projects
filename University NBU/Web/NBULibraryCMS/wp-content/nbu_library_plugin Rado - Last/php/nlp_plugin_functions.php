...
function nlp_human_translator_blocks($i, $day_name = "accepted") {
    /* NOVO 17/08/2015 */
...
//        $category_term_id = filter_input(INPUT_POST, 'nlp_value_integer_send', FILTER_SANITIZE_NUMBER_INT);
    ...
    /* 18.08.2015 */
//    $return_possible_days_months .= '<p class="description">';
//    $return_possible_days_months .= 'Качете PDF файлът тук.';
//    $return_possible_days_months .= '</p>';
//    $return_possible_days_months .= '<input type="file" id="nlp_uploader_meta" name="nlp_uploader_meta" value="" size="25" />';
    /* 18.08.2015 */
    /* 18.08.2015*/
...
function nlp_day_of_months_front() {
    ...
    $return_days = '<div class="nlp_select_calendar_view" id="'.$user_id.'">';
    ...
    $return_days .= "<select class='year_calendar_view'>";
            ...
            if ($i == 1) {
                ...
                if (!empty($taken_or_not)) {
                    foreach ($taken_or_not as $key => $index) {
                        ...
                        if ($index != "") {
                            $inner_days_info .= "<div>" . nlp_human_translator_blocks($key, $day_name_class) . " </div>";
                        }
                    }
                }
                ...
                if (!empty($taken_or_not)) {
                    foreach ($taken_or_not as $key => $index) {
                        ...
                        if ($index != "" && isset($taken_or_not_info[$key])) {
...
$inner_days_info .= "TREST".$i .":". $hall_id ." :" . $year_selected;
                    $inner_days_info .="</div>";
