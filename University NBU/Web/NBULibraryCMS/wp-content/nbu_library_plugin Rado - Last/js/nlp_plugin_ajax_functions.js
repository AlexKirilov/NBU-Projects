...
//    });
    ...
    $(document).on('click', '#nlp_reserver_chosen_hours', function () {
        ...
        alert(value_use_of_tech);

//        var file_attached = $('#nlp_uploader_meta').prop('files');
        /*18.08.2015*/
        
//            var file = $('#nlp_uploader_meta').prop('files');
...
//                }
//            };
//            var datasss = "action=some_test&file="+file;
//            xhr.open('post', nlp_ajax.ajaxurl, true);
//            xhr.send(datasss);
//        
        /*18.08.2015*/
