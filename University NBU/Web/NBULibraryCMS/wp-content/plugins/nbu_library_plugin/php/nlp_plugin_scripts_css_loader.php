...
function nlp_plugin_admin_refresher_style_loader_responsive() {
    //Admin style for the admin page
    wp_register_style('nlp_plugin-css-responsive', plugins_url('/nbu_library_plugin/css/nlp_plugin_css_responsive.css'));

    wp_enqueue_style('nlp_plugin-css-responsive');
}

add_action('admin_init', 'nlp_plugin_admin_refresher_style_loader_responsive');
add_action('admin_menu', 'nlp_plugin_admin_refresher_style_loader_responsive');
add_action('wp_enqueue_scripts', 'nlp_plugin_admin_refresher_style_loader_responsive');
