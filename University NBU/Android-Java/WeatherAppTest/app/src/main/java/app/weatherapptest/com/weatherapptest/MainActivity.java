...
public class MainActivity extends ActionBarActivity {
    ...
    public void renderWeatherData( String city) {
        ...
        weatherTask.execute(new String[]{city + "&units=metric&appid=919becca01ec322740155deea66a4de9"});
...
private class DownloadImageAsyncTask extends AsyncTask<String, Void, Bitmap> {
    ...
    private class WeatherTask extends AsyncTask<String, Void, Weather> {
        ...
        protected void onPostExecute(Weather weather) {
            ...
            minTemp.setText("Мин темп: "+ weather.currentCondition.getMinTemperature()  + "°C");
            maxTemp.setText("Макс темп: "+ weather.currentCondition.getMaxTemperature()  + "°C");
            humidity.setText("Влажност: " + weather.currentCondition.getHumidity() + "%");
            pressure.setText("Налягане: " + weather.currentCondition.getPressure() + "hPa");
            wind.setText("Скорост на вятъра: " + weather.wind.getSpeed() + "mps");
            sunrise.setText("Изгрев : " + sunriseDate);
            sunset.setText("Залез: " + sunsetDate  );
            updated.setText("Последно обновяване: " + updateD );
            description.setText("Състояние: " + weather.currentCondition.getCondition() + "(" + weather.currentCondition.getDescription() + ")");
    ...
    private void showInputDialog() {
        ...
        builder.setTitle("Смени град");

        final EditText cityInput = new EditText(MainActivity.this);
        cityInput.setInputType(InputType.TYPE_CLASS_TEXT);
        cityInput.setHint("Sofia,BG");
        builder.setView(cityInput);
        builder.setPositiveButton("Потвърди", new DialogInterface.OnClickListener() {
            @Override
